...
public class ttss extends Activity {
    ...
    class newTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Dlog = new ProgressDialog(ttss.this);
            ...
            if (null == result || result.length() == 0)
            {
                ...
                try{
                    ...
                    if(itemList.size()==itemList2.size()){
                        ...
                        adapterEm = new customAdapter(ttss.this, itemList2);
    ...
    public void showToast(String msg) {
        Toast.makeText(ttss.this, msg, Toast.LENGTH_LONG).show();
    }
}
